...
export * from './exportEndPoint.service';
import { ExportEndPointService } from './exportEndPoint.service';
export * from './exportEndPoint.serviceInterface';
...
export const APIS = [DeleteEndPointService, ExportEndPointService, GetAllEndPointService, GetByIdEndPointService, PostEndPointService, PutEndPointService];
